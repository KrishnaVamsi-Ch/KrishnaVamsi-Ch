...
| 📋 **To-Do List CLI** | Task manager with file persistence | [View Project](https://github.com/KrishnaVamsi-Ch/todo-list-cli) |
| ☁️ **Weather API App** | Real-time weather info using OpenWeatherMap API | [View Project](https://github.com/KrishnaVamsi-Ch/weather-api-app) |
